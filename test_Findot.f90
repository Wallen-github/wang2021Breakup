...
104 format(1X, E25.18,1X,E25.18,1X,E25.18,1X,E25.18,1X,E25.18,1X,E25.18,1X,E25.18)
    ...
    write(*,*)  '=========================Find dots============================'
    write(*,*) 'tf = ',tf
    open(14,file='G:\Master\科研工作\Binary system\2020.7.9Paperwork\Pic\Migration3\DotsV1.txt',status='REPLACE')
    open(15,file='G:\Master\科研工作\Binary system\2020.7.9Paperwork\Pic\Migration3\DotsP1.txt',status='REPLACE')
