...
PROGRAM main
    ...
    external :: YHC2
    REAL(8) :: t0,tf,err,step,w0(2),hh,tspan,EE,x0(4),alphaS0,beta
...
107 format(1X, E25.18,1X,E25.18,1X,E25.18,1X,E25.18,1X,E25.18,1X,E25.18,1X,E25.18)
    ...
    CALL GetAB(alphaS0*S0,beta,0D0,0D0,x0)
    write(*,*) 'x0 ='
    write(*,104) x0
    ...
    open(12,file='G:\Master\科研工作\2020深空探测年会\orbit.dat', status='REPLACE')
    CALL Propagate2(12,YHC2,t0,tf,tspan,err,hh,Num,x0)
    close(12)
    write(*,*) '===============================End=================================='
    write(*,*) 'xt ='
    write(*,104) x0
