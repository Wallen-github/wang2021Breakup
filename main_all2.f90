...
113 format(1X, E25.18,1X,E25.18,1X,E25.18,1X,E25.18,1X,E25.18,1X,E25.18,1X E25.18,1X,E25.18,1X,E25.18,1X, E25.18,1X,E25.18,1X, E25.18,1X,E25.18)
    ...
    !读取状态量
    write(*,*)  '===========================Load data=============================='
    filename = "G:\Master\科研工作\Binary system\2020.7.9Paperwork\Pic\Migration3\JointIn4.dat"
    unitT = 3900 !外迁演化参数
    FILEID = 12
    ...
    ! 转换至alpha，beta
    open(15,file='G:\Master\科研工作\Binary system\2020.7.9Paperwork\Pic\Migration3\Dot.dat',status='REPLACE')
    CALL GetAB_re(x4,al,be,phi1,phi2)
    write(15,104) al/S0,be*18D1/PI,phi1,phi2
    close(15)
    ...
    tf = 1.5D2*(w0(2)/w1(2))
    write(*,*) 'tf = ',tf
    open(15,file='G:\Master\科研工作\Binary system\2020.7.9Paperwork\Pic\Migration3\Sta.dat',status='REPLACE')
    open(16,file='G:\Master\科研工作\Binary system\2020.7.9Paperwork\Pic\Migration3\AB.dat',status='REPLACE')
    CALL Contour_phi12(15,alS_max,alS_min,beD_max,beD_min,phi1,phi2,Num,tf)
    !CALL Contour_Energy(15,alS_max,alS_min,beD_max,beD_min,Num,tf)
    close(15)
    close(16)
